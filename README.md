...
### Tweaking
The amplification of the Instrumentation Amplifier can be adjusted to any of 8 levels from ### to ### by changing the MUXWIP value in the control registers. The Mindi schematic contains a table detailing the levels of gain and their associated register and resistor values.
